							...
							return (
								<Radio
									...
									classNames={{
										...
										base: cn(`flex w-[360px] flex-row items-center m-0 hover:shadow-gray-900 duration-300 min-w-full max-w-full rounded-large bg-content1/60 p-4 text-center shadow-small`),
									}}>
									<div className="flex gap-4">
										<MemoAvatar id={candidate.id} />
										<div className="flex flex-col items-start text-left my-auto">
											<h2 className="text-xl font-medium text-white/70 truncate">{fullName}</h2>
										</div>
									</div>
								</Radio>
							);
	...
	return (
		<>
			<div className="flex max-w-xl flex-col text-center h-full">
				<h2 className="font-medium text-white/70">{smallTitle}</h2>
