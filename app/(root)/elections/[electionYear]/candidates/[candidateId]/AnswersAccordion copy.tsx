					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto max-w-[600px]">
						{candidate.instagram && (
							<div style={{ background: "radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%)" }} className="p-4 rounded-2xl flex flex-col text-left justify-start">
								...
								<Spacer y={4} />
								<Button className="border-small border-black/10 bg-black/10 shadow-md light:text-black dark:border-white/20 dark:bg-white/10 w-auto">Follow</Button>
							</div>
						)}
						{candidate.facebook && (
						...
						{candidate.website && (
							<div className="p-4 rounded-2xl flex flex-col text-left justify-start bg-white text-black">
								...
								<Spacer y={4} />
								<Button className="border-small border-black/10 bg-black/10 shadow-md light:text-black dark:border-black/20 dark:bg-white/10 text-black w-auto">Visit</Button>
							</div>
						)}
					</div>
				</Tab>
