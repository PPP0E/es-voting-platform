...
const footerNavigation = {
	services: [
		{ name: "School's History", href: "https://englishschool.ac.cy/schools-history" },
...
export default function Component() {
	const renderList = ({ title, items }: { title: string; items: { name: string; href: string }[] }) => (
		<div>
			...
			<div className="px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8 md:pr-8">
						...
						<p className="text-small text-default-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed neque elit, tristique</p>
					...
					<div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
						<div className="md:grid md:grid-cols-2 md:gap-8">
							<div>{renderList({ title: "About Us", items: footerNavigation.services })}</div>
				...
				<div className="flex flex-wrap justify-between gap-2 pt-8">
					<p className="text-small text-default-400">&copy; {currentYear} The English School. All rights reserved.</p>
					<ThemeSwitch />
				</div>
			</div>
		</footer>
